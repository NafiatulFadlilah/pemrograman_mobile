...
String url_domain = "http://192.168.1.16:8000/";
                ...
                children: [
                  TableRow(children: [
                    Text(
                      ...
                      // This widget is the root of your application.   @override   Widget build(BuildContext context) {     return MaterialApp(       title: 'Flutter Demo',       theme: ThemeData(         colorScheme: ColorScheme.fromSeed(seedColor: Colors.deepPurple),         useMaterial3: true,
                      style:
...
// String url_show_data = url_domain + "api/show_data";
// String url_update_data = url_domain + "api/edit_data";
// String url_delete_data = url_domain + "api_delete_data";
...
//     }else if(state == AppLifecycleState.resumed){
//       // app is visible and running.
//       runApp(MyApp()); // run your App class agaim
//     }
//   }
...
//                                 showDialog(
//                                   context: context,
//                                   builder: (BuildContext context) => _buildPopupDialog_update(context));
//                               },
//                               child: Text("Update"),
//                             ),
//                             MaterialButton(
...
//                                 print("delete");
//                                 delete_data(data['id']!);
//                                 didChangeLifecycleState(AppLifecycleState.resumed);
//                               },
//                               child: Text("Delete"),
//                               ),
//                           ])
